...
---------------------------------------------
Concrete VisionProvider using Groq's native multimodal vision models.
Sends images directly to Llama 3.2 Vision.
"""
...
class GroqProvider(VisionProvider):
    """Groq Provider using native Vision API (Llama 3.2 Vision)."""
    ...
    async def extract(
        ...
        *,
        ...
        """
        Send both product images to Groq Vision and return a validated result.
        """
        ...
        try:
            logger.info("groq_vision_call_start", model=self._model_name, is_retry=retry_prompt is not None)
        ...
        try:
            ...
            # Reformat validation errors into a retry prompt
            error_details = []
